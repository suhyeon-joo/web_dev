...
@Setter
@Embeddable
public class IlsWorkStatusId implements java.io.Serializable {
    private static final long serialVersionUID = 7846547034748967800L;
    @NotNull
    ...
    public boolean equals(Object o) {
        ...
        IlsWorkStatusId entity = (IlsWorkStatusId) o;
